...
enemyTriggered :-
	...
	NewHP is HP + (Mult * 15),
	NewAttack is Attack + (Mult * 3),
	NewDefense is Defense + (Mult * 3),
...
enemyTriggered :-	
	...
	NewLevel is Level * Mult,
	NewHP is HP + (Mult * 15),
	NewAttack is Attack + (Mult * 4),
	NewDefense is Defense + (Mult * 4),
	NewGold is Gold + (Mult * 15),
	NewEXP is EXP + (Mult * 15),
	MaxHP is NewHP,
	asserta(triggeredEnemy(Name, NewLevel, MaxHP, NewHP, NewAttack, NewDefense, NewGold, NewEXP)),
...
enemyTriggered :-
	...
	NewLevel is Level * Mult,
	NewHP is HP + (Mult * 15),
	NewAttack is Attack + (Mult * 5),
	NewDefense is Defense + (Mult * 5),
	NewGold is Gold + (Mult * 15),
	NewEXP is EXP + (Mult * 15),
	MaxHP is NewHP,
	asserta(triggeredEnemy(Name, NewLevel, MaxHP, NewHP, NewAttack, NewDefense, NewGold, NewEXP)),
